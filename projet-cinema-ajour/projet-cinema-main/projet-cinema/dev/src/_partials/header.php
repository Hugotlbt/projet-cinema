        ...
        <div class="collapse navbar-collapse" id="navbarColor02">
            ...
            if (!empty($pseudo_utilisateur)) {
                echo '<div class="dropdown">
                          <button class="btn btn-danger dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">' . $pseudo_utilisateur . '</button>
                ...
                echo '<form class="d-flex" role="search">
                          <button class="btn btn-danger" type="submit"><a href="../connexion.php" class="text-decoration-none text-white">Se connecter</a></button>
                      </form>';
            }
            ?>
        </div>
